...
Contributions to the bot are always welcome. Just create a pull request for the [Comprobot repo](https://github.com/badluma/comprobot) on GitHub. If you aren't a coder, you can also make suggestions on my [Discord Server](https://discord.gg/g6rZtmQgbK) in the *suggestions* channel.
